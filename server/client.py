...
# Title: Client
# Generated: Wed Jan 17 23:22:07 2018
##################################################
...
class client(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 200, 0, 0, "")
        ...
        self.blocks_short_to_float_0_0 = blocks.short_to_float(1, 4)
        self.blocks_short_to_float_0 = blocks.short_to_float(1, 4)
        ...
        # Connections
        ##################################################
        self.connect((self.blks2_tcp_source_0, 0), (self.blocks_short_to_float_0_0, 0))
